...
execute as @a[tag=in_parkour,scores={reset=1..}] if entity @s run function uhc:parkour/trigger_reset.mcfunction
...
execute as @a[tag=in_parkour] if entity @e[distance=..1.5,type=armor_stand,scores={acheckpoint=1..}] run function uhc:parkour/at_checkpoint.mcfunction