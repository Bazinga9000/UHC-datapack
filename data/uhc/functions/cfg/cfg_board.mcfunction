...
execute if score mafia uhc.esoteric matches 0 run setblock -12 11 7 red_concrete
...
execute if score mafia uhc.esoteric matches 1 run setblock -12 11 7 lime_concrete
