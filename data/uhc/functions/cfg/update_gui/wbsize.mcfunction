...
for i in 9..17 run let v = size_bor_1 uhc.cfg run data modify storage uhc.cfg wbsize[{Slot:13b}].tag.display.Lore[0] set value '[{"text":"Diameter: ","color":"white","italic":false},{"text":"$v","color":"aqua"}]'
for i in 9..17 run let v = sizer_bor_1 uhc.internal run data modify storage uhc.cfg wbsize[{Slot:13b}].tag.display.Lore[1] set value '[{"text":"Stops at: ","color":"white","italic":false},{"text":"±$v","color":"aqua"}]'

for i in 18..26 run let v = size_bor_2 uhc.cfg run data modify storage uhc.cfg wbsize[{Slot:22b}].tag.display.Lore[0] set value '[{"text":"Diameter: ","color":"white","italic":false},{"text":"$v","color":"aqua"}]'
for i in 18..26 run let v = sizer_bor_2 uhc.internal run data modify storage uhc.cfg wbsize[{Slot:22b}].tag.display.Lore[1] set value '[{"text":"Stops at: ","color":"white","italic":false},{"text":"±$v","color":"aqua"}]'
