...
execute if score make_teams uhc.internal matches 1 unless entity @a[team=team1] run tellraw @s [{"text":"Teams have not been assigned. Press ","color":"red"},{"text":"[here] ","color":"blue","clickEvent":{"action":"run_command","value":"/function uhc:teams/assign"}},{"text":"to assign teams."}]
...
execute unless score dim_game_exist uhc.internal matches 1 run tellraw @s [{"text": "Dimension game has not been created. Press ", "color":"red"},{"text":"[here] ","color":"blue","clickEvent":{"action":"run_command","value":"/mvcreate game NORMAL"}},{"text":"to create dimension game."}]
execute unless score dim_gamen_exist uhc.internal matches 1 run tellraw @s [{"text": "Dimension game_nether has not been created. Press ", "color":"red"},{"text":"[here] ","color":"blue","clickEvent":{"action":"run_command","value":"/mvcreate game_nether NETHER"}},{"text":"to create dimension game_nether."}]
