...
execute if score game_started matches 0 if score dim_game_exist uhc.internal matches 1 if score dim_gamen_exist uhc.internal matches 1 if entity @a[team=team1] run function uhc:event/game_begins
...
execute unless score game_started matches 0 run tellraw @a[gamemode=creative] {"text": "Game has already started!", "color":"red"}