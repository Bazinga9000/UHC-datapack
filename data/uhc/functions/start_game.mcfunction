...
execute if score dim_game_exist uhc.internal matches 1 if score dim_gamen_exist uhc.internal matches 1 if entity @a[team=team1] run function uhc:event/game_begins
