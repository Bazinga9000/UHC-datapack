...
# X displays red
# Z displays blue
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 0 run data modify storage minecraft:uhc.hud ry set value '[{"text":"-X ","font":"uhc:hud0","color":"red"},{"text":"+Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 1 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud0"},{"text":"-X","color":"red"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 2 run data modify storage minecraft:uhc.hud ry set value '[{"text":"-X ","font":"uhc:hud0","color":"red"},{"text":"-Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 3 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud0"},{"text":"-Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 4 run data modify storage minecraft:uhc.hud ry set value '[{"text":"+X ","font":"uhc:hud0","color":"red"},{"text":"-Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 5 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud0"},{"text":"+X","color":"red"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 6 run data modify storage minecraft:uhc.hud ry set value '[{"text":"+X ","font":"uhc:hud0","color":"red"},{"text":"+Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 1 if score ry uhc.hud matches 7 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud0"},{"text":"+Z","color":"#6f6fff"}]'

execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 0 run data modify storage minecraft:uhc.hud ry set value '[{"text":"-X ","font":"uhc:hud1","color":"red"},{"text":"+Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 1 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud1"},{"text":"-X","color":"red"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 2 run data modify storage minecraft:uhc.hud ry set value '[{"text":"-X ","font":"uhc:hud1","color":"red"},{"text":"-Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 3 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud1"},{"text":"-Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 4 run data modify storage minecraft:uhc.hud ry set value '[{"text":"+X ","font":"uhc:hud1","color":"red"},{"text":"-Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 5 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud1"},{"text":"+X","color":"red"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 6 run data modify storage minecraft:uhc.hud ry set value '[{"text":"+X ","font":"uhc:hud1","color":"red"},{"text":"+Z","color":"#6f6fff"}]'
execute if score rightlen uhc.hud matches 2 if score ry uhc.hud matches 7 run data modify storage minecraft:uhc.hud ry set value '[{"text":"\\uf824\\uf824\\uf822","font":"uhc:hud1"},{"text":"+Z","color":"#6f6fff"}]'
