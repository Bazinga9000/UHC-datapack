...
#coord disp
for i in 3..21 run execute if score xyzlen uhc.hud matches $i run data modify storage minecraft:uhc.hud displist append value '[{"score":{"name":"x","objective":"uhc.hud"},"font":"uhc:hud1"},{"text":" "},{"score":{"name":"y","objective":"uhc.hud"}},{"text":" "},{"score":{"name":"z","objective":"uhc.hud"}},{"nbt":"xyzspacingsp[$i]","storage":"uhc.hud","interpret":"true"}]'
...
#  0 = displays blue
#  1 = displays red
for i in 1..8 run execute if score wblen uhc.hud matches $i if score wbclr uhc.hud matches 0 run data modify storage uhc.hud displist append value '[{"text":"\\ue000","color":"#338dff"},{"text":"\\uf822±","color":"white"},{"score":{"name":"wb","objective":"uhc.hud"},"color":"white"},{"nbt":"wbspacingsp[$i]","storage":"uhc.hud","interpret":"true"}]'
for i in 1..8 run execute if score wblen uhc.hud matches $i if score wbclr uhc.hud matches 1 run data modify storage uhc.hud displist append value '[{"text":"\\ue000","color":"red"},{"text":"\\uf822±","color":"white"},{"score":{"name":"wb","objective":"uhc.hud"},"color":"white"},{"nbt":"wbspacingsp[$i]","storage":"uhc.hud","interpret":"true"}]'
