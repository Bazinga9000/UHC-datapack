...
execute as @a store result score @s uhc.saturation run data get entity @s foodSaturationLevel 5
execute as @a[scores={uhc.saturation=26..}, gamemode=!creative, gamemode=!spectator] run effect give @s hunger 1 127 true
execute as @a[scores={uhc.saturation=..24}, gamemode=!creative, gamemode=!spectator] run effect give @s minecraft:saturation 1 0 true
execute as @a[scores={uhc.saturation=25}, gamemode=!creative, gamemode=!spectator] run effect clear @s minecraft:saturation
execute as @a[scores={uhc.saturation=25}, gamemode=!creative, gamemode=!spectator] run effect clear @s minecraft:hunger