...
tellraw @s ""
tellraw @s ["",{"text":"     "},{"text":"[<<]","color":"aqua","clickEvent":{"action":"run_command","value":"/function uhc:deprec_display/decrement_team"}},{"text":" ","color":"none"},{"score":{"name":"num_teams","objective":"settings"},"color":"dark_green"},{"text":" Teams ","color":"dark_green"},{"text":"[>>]","color":"aqua","clickEvent":{"action":"run_command","value":"/function uhc:deprec_display/increment_team"}}]
