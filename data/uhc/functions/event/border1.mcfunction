...
let t = border1s uhc.cfg run execute in minecraft:game run worldborder set 25 $t
let t = border1s uhc.cfg run execute in minecraft:game_nether run worldborder set 25 $t
